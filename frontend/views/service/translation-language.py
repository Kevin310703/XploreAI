...
if "translation_direction" not in st.session_state:
    st.session_state["translation_direction"] = "English → Vietnamese"
...
translation_direction = st.selectbox(
    ...
    index=0 if st.session_state["translation_direction"] == "English → Vietnamese" else 1
)

st.session_state["translation_direction"] = translation_direction
placeholder_text = ("Translate English text to Vietnamese..." 
                    if st.session_state["translation_direction"] == "English → Vietnamese"
